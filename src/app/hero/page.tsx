  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-black pt-16 lg:pt-0">
      ...
      <div className="absolute inset-0 z-1 opacity-10">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[size:80px_80px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,black,transparent)]"></div>
      ...
      <div className="relative z-20 w-full max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-4 lg:gap-8">
          <motion.div
            ...
            className="w-full lg:w-2/5 space-y-6 lg:space-y-8 border border-white/10 bg-black/20 backdrop-blur-sm p-4 sm:p-6 lg:p-8 rounded-2xl relative overflow-hidden mt-8 lg:mt-0"
          >
            ...
            <div className="absolute left-4 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-white/5 to-transparent"></div>
            <div className="absolute right-4 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-white/5 to-transparent"></div>
            ...
            >
              <h1 className="font-bold tracking-tight leading-[0.9]">
                <span className="block text-[8vw] sm:text-[6vw] md:text-[4vw] lg:text-[3.5vw] xl:text-[3vw] bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
                  LUXURY
                </span>
                <span className="block text-[4vw] sm:text-[3vw] md:text-[2.5vw] lg:text-[2vw] xl:text-[1.8vw] bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent mt-2">
            ...
            <motion.p
              ...
              className="text-[3.5vw] sm:text-[2.5vw] md:text-[1.5vw] lg:text-[1.2vw] xl:text-[1vw] text-gray-300 leading-relaxed font-light"
            >
              Experience timeless sophistication with our Luxury Chronograph
              Watch—a perfect blend of craftsmanship, precision, and style.
            ...
            <motion.div
              ...
              className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-6 relative"
            >
              <div className="absolute -left-2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-white/10 to-transparent"></div>
              <div className="absolute -right-2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-white/10 to-transparent"></div>
              <div className="absolute left-0 right-0 -top-2 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent"></div>
              <div className="absolute left-0 right-0 -bottom-2 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent"></div>
              ...
              {[
                ...
                >
                  ...
                  <div className="font-bold text-[5vw] sm:text-[3vw] md:text-[2vw] lg:text-[1.5vw] bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent relative z-10">
                    {stat.value}
                  </div>
          ...
          <motion.div
            ...
            className="w-full lg:w-3/5 flex items-center justify-center relative -mt-8 lg:mt-0"
          >
            <div className="relative w-full max-w-2xl sm:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-6xl aspect-square">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-amber-500/10 rounded-full blur-2xl sm:blur-3xl scale-105 sm:scale-110 -z-10"></div>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="absolute inset-0 z-1 overflow-hidden">
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-blue-500/5 rounded-full blur-2xl sm:blur-3xl"
        />
        <motion.div
          animate={{
            opacity: [0.4, 0.7, 0.4],
          ...
          className="absolute bottom-1/4 right-1/4 w-56 h-56 sm:w-80 sm:h-80 bg-amber-500/5 rounded-full blur-2xl sm:blur-3xl"
        />
      </div>
    </section>
  );
